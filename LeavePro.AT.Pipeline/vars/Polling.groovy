                        ...
                        for (changeLog in build.changeSets) {
                            ...
                            for(entry in changeLog.items) {
                                ...
                                for(file in entry.affectedFiles) {
                                    ...
                                    packCCF = Changes.findChanges(configList, file)
                                    configList = [
                                    ...
                                    buildPlatform = Changes.findChanges(configList[0], file)
                                    buildPlatformDb = Changes.findChanges(configList[1], file)
                                    configList = [
                                    ...
                                    buildSaaS = Changes.findChanges(configList[0], file)
                                    deploySaaSSSRS = Changes.findChanges(configList[1], file)
                                    buildSaaSDb = Changes.findChanges(configList[2], file)
                                    configList = [
                                    ...
                                    buildCurly = Changes.findChanges(configList[0], file)
                                    deployCurlySSRS = Changes.findChanges(configList[1], file)
                                    buildCurlyDb = Changes.findChanges(configList[2], file)
                                    configList = [
                                        ["Larry",buildLarrySS,["\$/Larry/AT/Source Code/Reed.Web.SelfService"]]
                                    ]
                                    buildLarrySS = Changes.findChanges(configList, file)
